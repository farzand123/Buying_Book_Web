...
const EditBook = () => {
  const [book, setBook] = useState({
    ...
    genres: ["scary"],
    IBAN: 123,
    createdAt: "2023-07-10T02:11:04.343Z",
    __v: 0,
  });
                  ...
                  >
                    <div className="form-outline mb-4">
                      <input
                        ...
                        value={book.title}
                        onChange={(e) => {
                          setBook({ ...data, title: e.target.value });
                        }}
                        type="text"
                        id="book-title"
                    ...
                    <div className="form-outline mb-4">
                      <input
                        ...
                        value={book.author}
                        onChange={(e) => {
                          setBook({ ...data, author: e.target.value });
                        }}
                        type="text"
                        id="author"
                        className="form-control"
                    ...
                    <div className="form-outline mb-4">
                      <input
                        ...
                        value={book.price}
                        onChange={(e) => {
                          setBook({ ...data, price: e.target.value });
                        }}
                        type="number"
                        id="price"
                        className="form-control"
                    ...
                    <div className="form-outline mb-4">
                      <input
                        ...
                        value={book.IBAN}
                        onChange={(e) => {
                          setBook({ ...data, IBAN: e.target.value });
                        }}
                        type="number"
                        id="iban"
                        className="form-control"
